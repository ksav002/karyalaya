...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2024 at 08:17 AM
...
(105, 1, 'This is assignment 2 of chapter 1 of CACS205. abcd', '2030-01-01', ''),
(106, 2, 'This is assignment 2 of chapter 2 of CACS205. efgh', '2029-11-14', ''),
(107, 1, 'This is assignment 1 of chapter 1 of CACS205. ijkl', '2024-03-05', ''),
(108, 2, 'This is assignment 1 of chapter 2 of CACS205. mnop', '2024-05-03', ''),
(131, 53, 'efrsefeser', '2024-05-08', 'question_663756f54bb206.60781696.pdf'),
(132, 47, 'fdf', '2024-05-16', 'question_66375959ad4b18.14660373.pdf'),
(133, 47, 'fd', '2024-05-21', 'question_66375d9cea88b7.70670099.pdf'),
(134, 63, 'fdgh', '2024-05-21', ''),
(135, 61, 'fgfgfghfghghfghdfhdfhhnjhgnb', '2024-05-16', 'question_66375fdcac7b02.55690140.pdf');
...
INSERT INTO `submission` (`submission_id`, `assignment_id`, `student_id`, `teacher_courses_id`, `uploaded_datetime`, `submission_file`) VALUES
(105, 105, 103, 1, '2024-04-29 05:00:03', ''),
(106, 105, 105, 1, '2024-04-29 05:17:36', ''),
(107, 106, 103, 1, '2024-04-29 05:20:13', ''),
(109, 107, 101, 1, '2024-05-15 09:50:40', 'answer_664485708e4a26.54342541.pdf'),
(111, 105, 101, 1, '2024-06-16 05:24:10', 'answer_666e76fa305c59.06262116.pdf');
...
INSERT INTO `teachers` (`teacher_id`, `fname`, `lname`, `phone`, `email`, `username`, `password`, `dob`, `active_status`) VALUES
(101, 'David', 'Garcia', 1234567890, 'david.garcia@example.com', 'daveg', '7d347cf0ee68174a3588f6cba31b8a67', '1980-06-01', 1),
(102, 'Jessica', 'Rodriguez', 9876543210, 'jessica.rodriguez@example.com', 'jessrodr', 'b06fd89c47434bb57edd340255b5ef73', '1985-11-17', 0),
(103, 'Daniel', 'Martinez', 1112223333, 'daniel.martinez@example.com', 'danmart', '6931702550544ff0db1db216f351192c', '1987-02-09', 1),
(104, 'Michelle', 'Lopez', 5554447777, 'michelle.lopez@example.com', 'michllop', '06ee2d4b9ce7961f4718f66da1851ed4', '1989-09-24', 0),
(105, 'Kevin', 'Hernandez', 9998887777, 'kevin.hernandez@example.com', 'kevhern', 'f8a1d9cf3df31609b223416d6352457c', '1992-05-08', 1);
...
--
ALTER TABLE `assignments`
  MODIFY `assignment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;

--
-- AUTO_INCREMENT for table `assignment_category`
--
ALTER TABLE `assignment_category`
  MODIFY `assignment_category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
