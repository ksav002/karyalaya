    ...
    <div id="create-category" class="modal">
        <form action="" method="post" onsubmit="return validateCreateCategoryForm()">
            <div class="input-control">
                ...
                <span class="error" id="category-name-error">
                    <?php if (isset($err['category_name'])) {
                        echo $err['category_name'];
                    } ?>
                </span>
            </div>
...
?>
    ...
    <div id="submit-file" class="modal">
        <form action="" method="post" enctype="multipart/form-data" onsubmit="return validateSubmitFileForm()">
            ...
            <div class="input-control">
                <label for="submission-file">Choose your file(pdf only): </label>
...
<div id="provide-feedback" class="modal">
    <form action="" method="post" id="provide-feedback-form" onsubmit="return validateFeedbackForm()">
        <input type="hidden" name="submissionId" id="submission-id" value=""> <!-- value comes from provideFeedback -->
        <div class="input-control">
            <label for="assignment-text">Enter feedback:</label><br>
            <textarea rows="5" cols="57" id="feedback-text" name="feedback_text"></textarea>
...
<?php 
 ...
 ?>
<!-- view feedback modal -->
<div id="view-feedback" class="modal">
    <div class="input-control">
        <label for="assignment-text">You received feedback from your teacher:</label><br>
        <textarea rows="5" cols="57" id="feedback-text" name="feedback_text" value="" disabled></textarea>
    </div>
</div>
<?php
 }
